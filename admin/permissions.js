...
export const PERMISSION_CATALOG = {
  ...
  /* ------------------------------------------------------------
     بيان الاتصال — أُضيف في المرحلة 6، وهو **للمالك وحده**.

     المرحلة أضافت رقم جوال للمستخدم، وطلب المالك أن يراه هو لا
     غيره. والطريق المباشر — requireRole("owner") — مغلق: الرتب
     الخطّية أُلغيت في المرحلة 5 لأنها منحت مدير المحتوى وصولاً
     كاملاً للمحاسبة، ويحرس غيابَها الفحصُ 11-د الذي يتأكد أن
     requireRole بلا مستدعٍ واحد.

     فالمفتاح هنا، ولا يُذكر في **أي** صف من صفوف MATRIX أدناه.
     وذلك وحده يكفي: صف المالك محسوب من ALL_PERMISSIONS لا مكتوب
     يدوياً، فينال هذه تلقائياً، ولا ينالها دور آخر لأن لا أحد
     أسندها له. صلاحية واحدة تغيّرت، وبقية الأدوار لم يتغيّر فيها
     حرف.

     ولماذا صلاحية مستقلة لا ضمن users:view: الجوال بيان تعريفي
     يخرج بالمستخدم من كونه صفاً في جدول. ومن يفرز الحسابات
     (الدعم) لا يحتاجه ليفرز، ومن يحرّر المحتوى لا شغل له به.
     ودمجه في users:view كان سيعطيه لأربعة أدوار دفعة واحدة.
     ------------------------------------------------------------ */
  "users:view_contact":       "رقم جوال المستخدم ودولته — بيان تعريفي، للمالك وحده",
